          ...
          <div className="row">
            ...
            <div className="col-lg-6 px-0">
              <div className="home-about-part-right">
                <h2 className="brand-color"><i class="fab fa-pagelines"></i> আমাদের পরিচিতি</h2>
                ...
                <button className="btn brand-bg text-white fw-bold">আরো পড়ুন <i class="fas fa-angle-double-right"></i></button>
              </div>
            </div>
          </div>
        </div>
